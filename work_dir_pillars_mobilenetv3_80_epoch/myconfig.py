...
db_sampler = dict(
    data_root='D:/A_github/mmdetection3d/data/kitti/',
    info_path='D:/A_github/mmdetection3d/data/kitti/kitti_dbinfos_train.pkl',
    rate=1.0,
    prepare=dict(
...
train_pipeline = [
    ...
    dict(
        type='ObjectSample',
        db_sampler=dict(
            data_root='D:/A_github/mmdetection3d/',
            info_path=
            'D:/A_github/mmdetection3d/data/kitti/kitti_dbinfos_train.pkl',
            rate=1.0,
            prepare=dict(
                filter_by_difficulty=[-1],
                filter_by_min_points=dict(Car=5, Pedestrian=5, Cyclist=5)),
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            data_root='D:/A_github/mmdetection3d/data/kitti',
            ann_file=
            'D:/A_github/mmdetection3d/data/kitti/kitti_infos_train.pkl',
            split='training',
            pts_prefix=
            'D:/A_github/mmdetection3d/data/kitti/training/velodyne_reduced',
            pipeline=[
                dict(
                    type='LoadPointsFromFile',
                    coord_type='LIDAR',
...
log_level = 'INFO'
work_dir = '../work_dir_pillars_mobilenetv3_40_epoch'
load_from = None
resume_from = '../work_dir_pillars_mobilenetv3_20_epoch/latest.pth'
workflow = [('train', 1)]
